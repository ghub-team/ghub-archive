  ...
  <separate /><p><br></p>
    ...
    <center>
        ...
        <form class="new-gdps-form">
            ...
            <input type="password" class="ngf-short-text" placeholder="Password" required autocomplete="current-password"><p>
            <button type="submit" class="ngf-publish">Log in</button><p></p>
        </form><br>
